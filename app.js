...
function renderProfileList(){var profiles=getProfiles(),list=document.getElementById('profile-list');list.textContent='';if(!profiles.length){var e=document.createElement('p');e.style.cssText='color:var(--text-muted);font-size:13px;text-align:center;padding:20px 0';e.textContent='Aucun profil. Creez votre premier budget!';list.appendChild(e);return;}profiles.sort(function(a,b){return(b.lastModified||'').localeCompare(a.lastModified||'');});profiles.forEach(function(prof){
